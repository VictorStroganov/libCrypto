...
let decryptedBytes = libCrypto.decrypt(encryptionResult.encryptedBytesArray, responderContainerName, senderCertFilename, encryptionResult.sessionKey, encryptionResult.IV, encryptionResult.sessionKey.sessionKeyBlob);
...
let decryptedBytes = libCrypto.decrypt(
	encBytesFromNet, responderContainerName, "cert.cer", encryptionResult.sessionKey, IVfromNet, blobFromNET);
*/
